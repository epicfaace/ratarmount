...
usage: ratarmount.py [-h] [-f] [-d DEBUG] [-c] [-r]
                     ...
                     [--index-folders INDEX_FOLDERS [INDEX_FOLDERS ...]]
                     [-o FUSE] [-v]
...
optional arguments:
  ...
  --index-folders INDEX_FOLDERS [INDEX_FOLDERS ...]
                        ...
                        suitability in the order they are given. An empty path
                        will be interpreted as the location where the TAR
                        resides. If it is the last argument before the
                        positional arguments, you will have to separate it
                        from them using "--". E.g., ratarmount --index-folders
                        "" foo alternative -- my.tar (default: ['',
                        '~/.ratarmount'])
